...
T_MIN_FIX = 60
MERGE_THRESHOLD = 100 # must be integer or float (in ms); only fixations with a time difference < MERGE_THRESHOLD will be merged. Set to 'None' T_MIN_SAC should be used as threshold.
